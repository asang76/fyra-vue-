...
<div class=" bg-contain bg-center bg-gradient-to-b from-dark-purple to-dark-purple " style="background-image:url('https://i.ibb.co/VwR3Zqw/tablet-g4de163fa6-1920.jpg')  background-repeat: no-repeat;" >
   <div class=" rounded-full text-white absolute font-extrabold  text-right opacity-30" style=" width:80px; height:40px;  font-size:100px; top:90px; right:1px  backdrop-filter:blur(2px)">Contact US
     </div>

<div class="text-center w-full bg-opacity-30 rounded-lg m-4 " style="backdrop-filter: blur(2px);">
    <!--
...
<div id="hide" class="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto  text-gray-900 rounded-lg ">
    <div class="flex flex-col top-bottom justify-between shadow-lg bg-yellow-700 bg-opacity-50 rounded-lg from-right m-4 p-12 "  style="backdrop-filter:blur(2px);">
        <div>
            <h2 id="text-hide" class="text-4xl  lg:text-5xl font-bold text-light-yellow leading-tight">Lets talk about everything!</h2>
            <h2 id="text-show" class="text-4xl hidden lg:text-5xl font-bold text-light-yellow leading-tight">Thank you for writing to us!</h2>
    ...
    <div id="away" v-if="!contact_msg" class=" shadow-lg bg-yellow-700 top-bottom p-12 bg-opacity-50 rounded-lg from-right m-4" style="backdrop-filter:blur(10px);">
    <form method="POST"  @submit.prevent="send_email">
    <div class="">
        <div>
            <span class="uppercase text-sm text-light-yellow font-bold">Full Name</span>
            <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="text" name="fullname"  :value="fullname" placeholder="">
        </div>
        <div class="mt-8">
            <span class="uppercase text-sm text-light-yellow font-bold">Email</span>
            <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" name="email" :value="email" type="text">
        </div>
        <div class="mt-8">
            <span class="uppercase text-sm text-light-yellow font-bold">Message</span>
            <textarea class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" name="message" :value="message"></textarea>
        </div>
        <div class="mt-8">
    ...
    <!-- <div v-else>
         <h2 class="text-2xl lg:text-3xl font-bold leading-tight pt-20">Thank you for writing to us!</h2>
...
<script>
 ...
 export default {
    ...
    var text2 = document.getElementById('text-show')
    btn.addEventListener('click', function () {
      btn.classList.add('animation')
      away.classList.add('animation')
      show.classList.add('transition')
